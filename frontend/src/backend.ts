...
export class Backend implements backendInterface {
    ...
    async loginUser(arg0: LoginData): Promise<void> {
        if (this.processError) {
            try {
    ...
    async registerUser(arg0: RegistrationData): Promise<void> {
        if (this.processError) {
            try {
    ...
    async resetPassword(arg0: PasswordResetData): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetPassword(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
